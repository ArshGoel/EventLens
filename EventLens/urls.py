...
urlpatterns = [
    ...
    path('dashboard/event/<int:event_id>/collection/add/', dash_views.add_collection, name='add_collection'),
    path('dashboard/collection/<int:collection_id>/delete/', dash_views.delete_collection, name='delete_collection'),
    path('dashboard/photo/<int:photo_id>/collection/', dash_views.update_photo_collection, name='update_photo_collection'),
